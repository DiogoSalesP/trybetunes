...
O objetivo é permitir que os usuários possam ouvir suas músicas favoritas de forma prática e intuitiva.
O projeto utiliza tecnologias web modernas, incluindo React, TypeScript, para criar uma interface interativa e responsiva. Além disso, a aplicação consome o itunes da apple para obter informações sobre as músicas e reproduzi-las.

# Funcionalidades 
  - Pesquisar músicas por nome, artista ou álbum.
  - Reproduzir trechos das músicas diretamente na aplicação.
  - Ver informações detalhadas sobre uma música específica, incluindo nome do artista, álbum e capa do álbum.
  - Adicionar músicas à lista de reprodução.
  - Remover músicas da lista de reprodução.
  - Controle básico de reprodução, como pausar, reproduzir e avançar/retroceder para a próxima/faixa anterior.
  
# Instalação
  1. Clone o repositório

  - Use o comando: `git clone https://github.com/DiogoSalesP/trybetunes.git`.
...
# Como usar
Na página inicial do TrybeTunes, você verá uma barra de pesquisa no topo.
Digite o nome de uma música, artista ou álbum que deseja ouvir e clique no botão de pesquisa.
Uma lista de resultados será exibida abaixo da barra de pesquisa. Clique no botão "Play" para reproduzir um trecho da música diretamente na aplicação.
Para obter mais informações sobre uma música específica, clique no botão "Ver detalhes".
Na página de detalhes da música, você pode ver informações como nome do artista, álbum e a capa do álbum. Também é possível adicionar a música à lista de reprodução clicando no botão "Adicionar à lista".
Para acessar a lista de reprodução, clique no ícone da playlist na barra de navegação superior.
Na página da lista de reprodução, você verá as músicas que foram adicionadas. É possível remover uma música da lista clicando no botão "Remover" ao lado de cada música.
Controle a reprodução das músicas usando os botões "Play" e "Pause". Use os botões de avançar e retroceder para alternar entre as faixas da lista de reprodução.

# Contato
Se você tiver alguma dúvida ou sugestão relacionada a este projeto, sinta-se à vontade para entrar em contato com os mantenedores:

Diogo Sales<br />
Email: diogosales.ads@gmail.com <br />
GitHub: https://github.com/DiogoSalesP <br />
Agradecemos seu interesse em contribuir para o TrybeTunes! Divirta-se ouvindo música!
